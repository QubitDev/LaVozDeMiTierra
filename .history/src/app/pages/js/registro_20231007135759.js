...
function onSubmit(event) {
  ...
  if (!titulo || !musica || !procedencia || !formato || !narrador || !tipoAudioSeleccionado || !audio || !text) {
    alert("Por favor, complete todos los campos y seleccione los archivos antes de enviar el formulario.");
    return; // Detiene la ejecución si falta algún campo o archivo
  }
