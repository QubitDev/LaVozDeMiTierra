...
const  titulo = document.getElementById("titulo__audio")document.getElementById("titulo__audio")
const narradorAudio;
const musicaF

const audioElement = document.getElementById("elIDDeTuAudio");
...
db.collection("audio").doc(docId).get().then((doc) => {
  if (doc.exists) {
      ...
      document.getElementById("musica__fondo").innerText = `Música de Fondo: ${data.musica}`
