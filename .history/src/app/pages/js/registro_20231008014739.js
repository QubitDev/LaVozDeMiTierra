...
function onSubmit(event) {
  ...
  const fields = [
    { valor: titulo, : "Título de audio", minimumLength: 4, elementoError: "error_titulo_audio" },
    { valor: musica, : "Música de fondo", minimumLength: 4, elementoError: "error_musica_fondo" },
    { valor: procedencia, : "Procedencia", minimumLength: 4, elementoError: "error_procedencia" },
    { valor: narrador, : "Narrador", minimumLength: 4, elementoError: "error_narrador" },
  ];
