...
function onSubmit(event) {
  ...
  const fields = [
    { valor: titulo, nombre: "Título de audio", : 4, elementoError: "error_titulo_audio" },
    { valor: musica, nombre: "Música de fondo", : 4, elementoError: "error_musica_fondo" },
    { valor: procedencia, nombre: "Procedencia", : 4, elementoError: "error_procedencia" },
    { valor: narrador, nombre: "Narrador", : 4, elementoError: "error_narrador" },
  ];
