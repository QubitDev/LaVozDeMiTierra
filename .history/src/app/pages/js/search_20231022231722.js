...
const container_eearch = document.querySelector('.container__search');
const menuSearch = document.querySelector('.menu__item[data-page="registro"]');
...
menuSearch.addEventListener('click', () => {
  if (isContainerVisible) {
    ...
    containerSearch.style.transform = 'translateY(-100%)';
  } else {
    // Mostrar el contenedor con un efecto de deslizamiento hacia abajo
    containerSearch.style.transform = 'translateY(0)';
  }
