...
async function onSubmit(event) {
  ...
  setTimeout(() => {
    loadingElement.style.display = 'none'; // Oculta el elemento de carga
    onMessagePopup(`✅¡Se subió correctamente el audio!🎉`, 450); // Muestra el popup
  }, 10000); // 10 segundos de espera
}

En este código, cuando se presiona el botón onSubmit, primero se muestra el mensaje de carga (loadingElement). Luego, se verifica si el título es único y se continúa con la lógica. Una vez que la operación haya finalizado (en este caso, después de 10 segundos, como solicitaste), se oculta el elemento de carga y se muestra el popup. Puedes ajustar el tiempo de espera según tus necesidades.
