...
searchInput.addEventListener('input', () => {
    ...
    const filteredDocumentos = snapshot.docs.filter(documento => {
        ...
        return titulo.includes(searchTerm) || procedencia.includes(searchTerm) || narrador.includes(searchTerm) || duracion.includes(searchTerm);
    });
