...
function mostrarBuscar() {
    ...
    if (isContainerVisible) {
        ...
        container_search.style.display = 'none'; // Oculta el contenedor
    } else {
        // Mostrar el contenedor con un efecto de cortina hacia abajo
        container_search.style.height = '75%'; // Ajusta la altura deseada
        container_search.style.display = 'block'; // Muestra el contenedor

        // Aplicar una transición suave de 0.5 segundos (puedes ajustar la duración)
        container_search.style.transition = 'height 0.5s';
    }
    isContainerVisible = !isContainerVisible;
}
