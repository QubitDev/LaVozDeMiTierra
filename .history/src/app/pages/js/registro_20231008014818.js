...
function onSubmit(event) {
  ...
  const fields = [
    { valor: titulo, name: "Título de audio", minimumLength: 4, error: "error_titulo_audio" },
    { valor: musica, name: "Música de fondo", minimumLength: 4, error: "error_musica_fondo" },
    { valor: procedencia, name: "Procedencia", minimumLength: 4, error: "error_procedencia" },
    { valor: narrador, name: "Narrador", minimumLength: 4, error: "error_narrador" },
  ];
