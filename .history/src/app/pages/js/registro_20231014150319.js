...
document.addEventListener("DOMContentLoaded", function() {
  const id_doc = document.getElementById("id__doc").textContent;
  console.log("id_doc: ", id_doc);

  function onVerifyButton() {
    window.location.href = `http://localhost/LaVozDeMiTierra/src/app/pages/html/prueba.html?id__doc=${id_doc}`;
    resetForm();
  }
