...
function validateTitle(inputElement) {
  ...
  const errorDiv = document.getElementById("titulo_audio_error");

  if (!/^[a-zA-Z\s]+$/.test(inputValue)) {
    // Si el valor no es alfabético o contiene caracteres especiales, mostrar el div de advertencia
    errorDiv.style.display = "block";
  } else {
    // Si el valor es válido, ocultar el div de advertencia
