...
audioFileInput.addEventListener("change", function () {
  ...
  if (selectedAudioFile) {
    ...
    // Puedes usar el objeto FileReader para leer el contenido del archivo
    const reader = new FileReader();

    reader.onload = function (event) {
      // El contenido del archivo de audio estará en event.target.result
      const audioData = event.target.result;
      console.log("Datos del archivo de audio:", audioData);

      // Puedes reproducir el audio o realizar cualquier otra operación necesaria aquí
    };

    // Lee el archivo como un blob de datos
...
function updateAcceptAttribute() {
  ...
  } else if (formatoSelect.value === "WAV") {
    audioFileInput.accept = ".wav";
  } else if (formatoSelect.value === "AIFF") {
    audioFileInput.accept = ".aiff";
  } else {
    audioFileInput.accept = ""; // Borra cualquier restricción de tipo de archivo si no se selecciona ninguna opción
  }
}
