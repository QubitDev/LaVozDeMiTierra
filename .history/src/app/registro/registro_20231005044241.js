...
const tituloAudioInput = document.getElementById("titulo_audio");

// Agregar un evento 'input' para validar en tiempo real
tituloAudioInput.addEventListener("input", function (event) {
  const inputValue = event.target.value;

  if (!/^[a-zA-Z\s]+$/.test(inputValue)) {
    // Si el valor no es alfabético o contiene caracteres especiales, evitar su ingreso
