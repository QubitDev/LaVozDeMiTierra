...
function addLista() {
    ...
    <div class="list">
        ...
        <h1 class="titleLi" contenteditable="true">Lista número ${number}</h1>
        <h1 class="Audios">Número de audios:</h1>
        <h1 class="number" type="number">0</h1>
        <button class="deleteC" onclick="eliminarLista(this)">
...
// Recorre cada elemento de imagen y agrega un event listener de clic
showList.forEach(image => {
    image.addEventListener("click", showListL);
});
